...
public class moveCharArchived : MonoBehaviourPun
{
    ...
    void Awake()
    {
        ...
        if(PhotonNetwork.IsConnected) {
            ...
            if(PV.IsMine) PV.RPC("UpdateGSPlayerList", RpcTarget.All);
    ...
    void OnCollisionExit2D(Collision2D coll) {
        ...
        [PunRPC]
    void UpdateGSPlayerList() {
        GS.players.Add(this.gameObject);
    }
